...
const projects = [
  {
    id: 1,
    title: 'Jastipal',
    description: 'Built full-stack features end-to-end including dual transaction flows, iPaymu payment gateway integration, escrow mechanism, KYC verification, dispute system, and admin dashboard using Next.js, Supabase (PostgreSQL + RLS), and deployed on Vercel with Supabase Edge Functions for backend logic.',
    role: 'Lead Developer',
    skills: ['Next.js', 'PostgreSQL', 'Supabase', 'iPaymu', 'Typescript', 'Tailwind CSS'],
    image: 'showcase project/jastipal.jpg',
    github: 'https://github.com/rahmaliyyah/Jastipal/',
    live: 'https://jastipal.vercel.app/',
  },
  {
    id: 2,
    title: 'Secvis',
    description: 'An on-premise web dashboard for real-time APD monitoring at PT Epson Indonesia maintenance area',
    role: 'Fullstack Programmer',
    skills: ['Laravel', 'PHP', 'MySQL', 'Tailwind CSS', 'React.js'],
    image: 'showcase project/secvis.png',
    github: 'https://github.com/rahmaliyyah/Secvis/',
    live: 'https://github.com/rahmaliyyah/Secvis/',
  },
  {
    id: 3,
    title: 'KarirUB',
  ...
  },
  {
    id: 4,
    title: 'Kroma',
    description: 'A web-based comic digital platform for creating and sharing digital comics.',
    role: 'Fullstack Programmer',
    skills: ['Laravel', 'PHP', 'MySQL', 'Vue.js'],
    image: 'showcase project/kroma.jpg',
    github: 'https://github.com/rahmaliyyah/kroma',
    live: 'https://github.com/rahmaliyyah/kroma',
  },
  {
    id: 5,
    title: 'TrustArisan',
  ...
  },
  {
  ...
  },
   {
    id: 7,
    title: 'KasirKita',
    description: 'A mobile point-of-sale (POS) application for small businesses with inventory management, sales tracking, and reporting features.',
    role: 'Mobile Developer',
    skills: ['Kotlin', 'Android Studio', 'Supabase', 'PostgreSQL'],
    image: 'showcase project/kasirkita.jpg',
    github: 'https://github.com/rahmaliyyah/KasirKita',
    live: 'https://github.com/rahmaliyyah/KasirKita',
  },
  {
    id: 8,
    title: 'TukarBaju',
  ...
  },
  {
    ...
    description: 'A responsive personal portfolio website built with React.js, Three.js and Tailwind CSS to showcase projects and skills.',
    role: 'Solo Project',
    skills: ['React.js', 'Tailwind CSS', 'TypeScript', 'Three.js'],
